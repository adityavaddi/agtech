...
export function createBlockProductionApi(action) {

  //var randomNumber = Math.floor((Math.random() * 10000000) + 1);
  //console.log("randomNumber",randomNumber);
  const BlockProductionDataModel = {
	 [action.blockData.id]:{
             ...
             "measuredEntityObjectives": action.data,
             "information":action.blockData.information!==undefined?action.blockData.information:null,
             "annual": action.blockData.annual!==undefined?action.blockData.annual:null,
  ...
  //console.log("vineyardUrl",vineyardUrl,vineyardUrl1);
        ...
        var obj = {
          ...
          body:JSON.stringify(BlockProductionDataModel)
        };
  return(
