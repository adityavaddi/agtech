...
export function createBlockParameterApi(action) {

  //var randomNumber = Math.floor((Math.random() * 10000000) + 1);
  //console.log("randomNumber",randomNumber);
  const BlockParameterDataModel = {
	 [action.blockData.id]:{
             ...
             "measuredEntityProperties": action.data,
  ...
  //console.log("vineyardUrl",vineyardUrl,vineyardUrl1);
        ...
        var obj = {
          ...
          body:JSON.stringify(BlockParameterDataModel)
        };
  return(
