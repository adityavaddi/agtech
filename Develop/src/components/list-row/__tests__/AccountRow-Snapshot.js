...
// Global Vars
//var mockData = require('../../../../MockData/LMC-MockData.json');
var mockData =
   { accountName: 'hahn',
...
describe('Testing AccountRow Component for UI Content', () => {
   it('Expect to AccountRow Component for snapshot', () => {
       const AccountRowTree = renderer.create(<AccountRow data={mockData}/>).toJSON();
       expect(AccountRowTree).toMatchSnapshot();
   });
 });
